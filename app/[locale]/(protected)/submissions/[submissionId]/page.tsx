 ...
 * 
 * This page displays detailed information about a form submission.
 * It includes:
...
export default async function SubmissionPage(props: PageProps) {
  ...
  // Log the style being passed to FormPreview
  console.log('Style being passed to FormPreview:', submission.form.style);
